...
// Skybill Params
	...
	public CONST __reg_oneSkybillMode = '/^(PDF|PPR|SPD|THE|Z2D|JSON|ZPL|SLT|XML|THEPSG|Z2DPSG)$/';
...
// common
	...
	public CONST __reg_string32 = '/^[a-zA-Z\d -_]{0,32}$/';
	public CONST __reg_string100 = '/^[a-zA-Z\d -_]{1,100}$/';
	public CONST __reg_string200 = '/^[a-zA-Z\d -_]{1,200}$/';
	public CONST __reg_string255 = '/^[a-zA-Z\d \r\n-_]{1,255}$/';
